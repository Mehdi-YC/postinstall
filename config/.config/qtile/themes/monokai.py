...
def init_widgets_list(monitor_num):
    widgets_list = [
        ...
        widget.TextBox(text = "󰔐", fontsize = 14, font = "JetBrainsMono Nerd Font", padding=11, foreground = colors[0], background = colors[7]),
        ...
        widget.Sep(linewidth = 0, padding = 10),
        widget.TextBox(text = "󰖓", fontsize = 22, font = "JetBrainsMono Nerd Font Mono", padding=10, foreground = colors[0], background = colors[3]),
        widget.OpenWeather(
        ...
        widget.Sep(linewidth = 0, padding = 10),
        widget.TextBox(text = " ", fontsize = 16, padding = 8, font = "JetBrainsMono Nerd Font Mono", foreground = colors[0], background=colors[9]),
        widget.CPU(
            font = "JetBrainsMono Nerd Font",
            update_interval = 1.0,
            format = '{load_percent}%',
        ...
        widget.Sep(linewidth = 0, padding = 10),
        widget.TextBox(text = "󱍥", padding = 11, font = "JetBrainsMono Nerd Font Mono", fontsize = 22, foreground = colors[0], background = colors[10]),
        widget.Memory(
        ...
        widget.Sep(linewidth = 0, padding = 10),
        widget.TextBox(text = "", fontsize = 22, font = "JetBrainsMono Nerd Font Mono", padding = 11, foreground = colors[0], background = colors[5]),
        widget.Clock(format='%I:%M %p', font = "JetBrainsMono Nerd Font", padding = 10, foreground = foregroundColor, background = colors[11]),
        widget.Sep(linewidth = 0, padding = 10, foreground = colors[5], background = backgroundColor),
        widget.CurrentLayoutIcon(scale = 0.5, foreground = colors[7], background = colors[1]),
    ]
...
screens = [
    Screen(top=bar.Bar(widgets=widgets_list, size=27, background=backgroundColor, margin=3, opacity=0.8),),
    Screen(top=bar.Bar(widgets=secondary_widgets_list, size=27, background=backgroundColor, margin=3, opacity=0.8),),
    ]
